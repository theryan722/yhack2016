<?php
        ...
        if (strcmp("add", $method) == 0) {
                ...
                $query = "INSERT INTO charity (title, description, address, price, email, state, id)
                VALUES ('{$title}', '{$dsc}', '{$address}', '{$price}', '{$email}', '{$state}', '{$id}')";
                ...
                $query = "UPDATE charity SET state='{$state}' WHERE id='{$id}'";
